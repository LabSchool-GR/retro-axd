...
<section class="space-y-6">
    ...
    <header>
        <h2 class="text-lg font-semibold text-gray-700 flex items-center">
            ...
            <?php echo e(__('app.auth.delete_account')); ?>

        </h2>
        <p class="mt-2 text-sm text-gray-600">
            <?php echo e(__('app.auth.delete_warning')); ?>
...
<?php $component->withAttributes(['name' => 'confirm-user-deletion','show' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->userDeletion->isNotEmpty()),'focusable' => true]); ?>
        <form method="post" action="<?php echo e(route('profile.destroy')); ?>" class="p-6">
            ...
            <h2 class="text-lg font-medium text-gray-800">
                <?php echo e(__('app.auth.delete_confirm_title')); ?>

            </h2>

            <p class="mt-2 text-sm text-gray-600">
                <?php echo e(__('app.auth.delete_confirm_text')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-label','data' => ['for' => 'password','class' => 'sr-only','value' => __('app.registerform.password')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'password','class' => 'sr-only','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('app.registerform.password'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'password','name' => 'password','type' => 'password','class' => 'mt-1 block w-full max-w-sm','placeholder' => ''.e(__('app.registerform.password')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'password','name' => 'password','type' => 'password','class' => 'mt-1 block w-full max-w-sm','placeholder' => ''.e(__('app.registerform.password')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\retro-axd\resources\views/profile/partials/delete-user-form.blade.php ENDPATH**/ ?>