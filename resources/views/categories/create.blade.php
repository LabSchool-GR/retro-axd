                    ...
                    <form method="POST" action="{{ route('admin.categories.store') }}">
                        ...
                        <div class="mb-8">
                            ...
                            <textarea name="description" id="description" rows="4"
                                      class="block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="flex justify-end space-x-2">
                            <button type="submit"
                                ...
                                <i class="fas fa-save mr-1"></i> {{ __('categories.save') }}
                            </button>
                        </div>
                    </form>
                </div>
